...
public class PendingOrderAdapter extends RecyclerView.Adapter<PendingOrderAdapter.OrderViewHolder> {
    private List<OrdersRoot.Datum> data = new ArrayList<>();
    ...
    public void addData(List<OrdersRoot.Datum> data) {
    ...
    public class OrderViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setModel(OrdersRoot.Datum datum) {

            if(datum.getAssignedAt() != null) {
                binding.tvtime.setText(datum.getAssignedAt());
            }
            ...
            if(addressStr != null && !addressStr.equals("")) {
                try {
                    ...
                    if(addressObj != null) {
                        ...
                        binding.tvdistence.setText(datum.getDistance().concat(" Km"));
